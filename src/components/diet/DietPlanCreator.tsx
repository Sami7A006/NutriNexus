...
const DietPlanCreator: React.FC<DietPlanCreatorProps> = ({ 
  ...
  const isFormValid = () => {
    return formData.goal && formData.timeframe && formData.activityLevel && 
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Create your personalized Indian diet plan based on your preferences and goals.
        </p>
      ...
      {formData.currentWeight && formData.targetWeight && formData.timeframe && (
        <WeightProgressChart
